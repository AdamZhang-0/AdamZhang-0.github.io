...
![0](C:\blogs\AdamZhang-0.github.io\assets\pic\0.jpg)

其中，-E即预处理后立即停止，不再进行编译。预处理后的代码送往标准输出，仅限C预处理器预处理所有指定的C源文件。

执行如下命令可得到预处理文件hello.i

![1](C:\blogs\AdamZhang-0.github.io\assets\pic\1.jpg)
...
![2](C:\blogs\AdamZhang-0.github.io\assets\pic\2.jpg)

![3](C:\blogs\AdamZhang-0.github.io\assets\pic\3.jpg)

![4](C:\blogs\AdamZhang-0.github.io\assets\pic\4.jpg)

在上千行的预处理文件的最后可看到我们自己编写的源程序，除了注释被删除外并没有变化。

![5](C:\blogs\AdamZhang-0.github.io\assets\pic\5.jpg)
...
![6](C:\blogs\AdamZhang-0.github.io\assets\pic\6.jpg)

### 3.3 Hello的编译结果解析

​	利用vim编辑器查看生成的文本文件，可见所有高级语言都被替换为汇编语句，如下图，此时文本由原来的一千多行变为短短的近百行。

![7](C:\blogs\AdamZhang-0.github.io\assets\pic\7.jpg)
...
![8](C:\blogs\AdamZhang-0.github.io\assets\pic\8.jpg)

![9](C:\blogs\AdamZhang-0.github.io\assets\pic\9.jpg)
...
![10](C:\blogs\AdamZhang-0.github.io\assets\pic\10.jpg)
...
![11](C:\blogs\AdamZhang-0.github.io\assets\pic\11.jpg)
...
![12](C:\blogs\AdamZhang-0.github.io\assets\pic\12.jpg)
...
![13](C:\blogs\AdamZhang-0.github.io\assets\pic\13.jpg)
...
![14](C:\blogs\AdamZhang-0.github.io\assets\pic\14.jpg)
...
![15](C:\blogs\AdamZhang-0.github.io\assets\pic\15.jpg)
...
![16](C:\blogs\AdamZhang-0.github.io\assets\pic\16.jpg)
...
![17](C:\blogs\AdamZhang-0.github.io\assets\pic\17.jpg)

​	首先看一下ELF头

​	hello.o

![18](C:\blogs\AdamZhang-0.github.io\assets\pic\18.jpg)

​	hello

![19](C:\blogs\AdamZhang-0.github.io\assets\pic\19.jpg)

​	与可重定位的elf头做一下比较，发现文件类型已经从REL转变为EXEC，说明现在文件可被执行。除此之外，原先像程序入口这样的参数已经有了确定的值，节的数目比可重定位文件多了12个。

​	hello各节信息如下：

![20](C:\blogs\AdamZhang-0.github.io\assets\pic\20.jpg)

![21](C:\blogs\AdamZhang-0.github.io\assets\pic\21.jpg)

![22](C:\blogs\AdamZhang-0.github.io\assets\pic\22.jpg)

### 5.4 hello的虚拟地址空间

​	从0x400200开始，在edb中可以清晰的看到进程虚拟地址空间各节的信息。

![23](C:\blogs\AdamZhang-0.github.io\assets\pic\23.jpg)

### 5.5 链接的重定位过程分析

![24](C:\blogs\AdamZhang-0.github.io\assets\pic\24.jpg)
...
![25](C:\blogs\AdamZhang-0.github.io\assets\pic\25.jpg)

_init后plt

![26](C:\blogs\AdamZhang-0.github.io\assets\pic\26.jpg)
...
![27](C:\blogs\AdamZhang-0.github.io\assets\pic\27.jpg)
...
![28](C:\blogs\AdamZhang-0.github.io\assets\pic\28.jpg)
...
![29](C:\blogs\AdamZhang-0.github.io\assets\pic\29.jpg)

### 6.6 hello的异常与信号处理

​	hello程序正常执行的效果如下图，设置秒数为1，经过八次循环后进程被回收，按下回车键就退出程序回到父进程。

![30](C:\blogs\AdamZhang-0.github.io\assets\pic\30.jpg)

​	当我们放飞自我，随意乱按时，进程的表现如下图

![31](C:\blogs\AdamZhang-0.github.io\assets\pic\31.jpg)

​	没有任何影响。

​	疯狂乱按并回车时，表现如下图

![32](C:\blogs\AdamZhang-0.github.io\assets\pic\32.jpg)

​	Getchar函数会在我们敲下回车符后将我们输入的字符串视为命令行进行输入。

​	输入ctrl-c时，父进程会强行终止并回收子进程，如下图

![33](C:\blogs\AdamZhang-0.github.io\assets\pic\33.jpg)

​	按crtl-Z后，用ps查看，发现进程依然存在

![34](C:\blogs\AdamZhang-0.github.io\assets\pic\34.jpg)

​	用jobs查看，jobs可以列出当前已启动进程的状态，图中显示其已经停止

![35](C:\blogs\AdamZhang-0.github.io\assets\pic\35.jpg)

​	使用pstree命令，如下图

![36](C:\blogs\AdamZhang-0.github.io\assets\pic\36.jpg)

​	以树状图形式显示的是当前进程。

​	使用fg后如下图

![37](C:\blogs\AdamZhang-0.github.io\assets\pic\37.jpg)
...
![38](C:\blogs\AdamZhang-0.github.io\assets\pic\38.jpg)
...
![39](C:\blogs\AdamZhang-0.github.io\assets\pic\39.jpg)

​	下图描述了使用k级页表层次结构的地址翻译。

![40](C:\blogs\AdamZhang-0.github.io\assets\pic\40.jpg)

​	在Intel Core i7环境下研究VA到PA的地址翻译问题

![41](C:\blogs\AdamZhang-0.github.io\assets\pic\41.jpg)
...
![42](C:\blogs\AdamZhang-0.github.io\assets\pic\42.jpg)
...
![43](C:\blogs\AdamZhang-0.github.io\assets\pic\43.jpg)

![44](C:\blogs\AdamZhang-0.github.io\assets\pic\44.jpg)
...
![45](C:\blogs\AdamZhang-0.github.io\assets\pic\45.jpg)
